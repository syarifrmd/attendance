...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-sm p-8 pb-10 border border-slate-100 dark:border-slate-800 relative z-10 my-8">
                <div className="text-center mb-8">
                    <h1 className="text-[26px] font-bold text-slate-900 dark:text-white mb-1">
                        Get Started Now
                    </h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400 max-w-62.5 mx-auto leading-relaxed">
                ...
                <div className="flex bg-[#F8F9FA] dark:bg-slate-800 rounded-full p-1.5 mb-8 border border-slate-100 dark:border-slate-700">
                    ...
                    <Link href={login()} className="flex-1 text-center bg-transparent py-2.5 text-sm font-semibold text-slate-400 dark:text-slate-500 rounded-full hover:text-slate-600 dark:hover:text-slate-300 transition-colors">
                        Log In
                    </Link>
                </div>
                ...
                <form onSubmit={submit} className="flex flex-col gap-5">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-2 px-1">First Name</label>
                                    <input
                                        type="text"
                                        name="first_name"
                                        ...
                                        required
                                        autoFocus
                                        className="w-full rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 py-3.5 px-5 focus:border-[#7D76F0] focus:ring-[#7D76F0] outline-none shadow-sm placeholder:text-slate-400 dark:placeholder:text-slate-500 text-slate-900 dark:text-white text-[14px]"
                                        placeholder="Raj"
                                    />
                                </div>
                                <div>
                                    <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-2 px-1">Last Name</label>
                                    <input
                                        type="text"
                                        name="last_name"
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-2 px-1">Email</label>
                                <input
                                    type="email"
                                    name="email"
                                    value={data.email}
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-2 px-1">Password</label>
                            ...
                            <div>
                                <label className="block text-xs font-medium text-slate-700 dark:text-slate-300 mb-2 px-1">Set Password</label>
                                <div className="relative">
                                    <input
                            ...
                            <a
                                href={googleAuth.url()}
                                className="flex items-center justify-center gap-2 rounded-full border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-800/50 py-3 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition active:scale-95"
                            >
